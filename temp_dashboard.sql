...
-- =====================================================================
-- VIEW 2 : STATISTIQUES DES RÃ‰SERVATIONS PAR STATUT
-- =====================================================================
...
-- =====================================================================
-- VIEW 3 : CLASSEMENT DES PARKINGS LES PLUS LOUÃ‰S
-- =====================================================================
...
SELECT 
    ...
    -- Notes et satisfaction ( CORRIGÃ‰: user_note au lieu de parking_note)
    AVG(COALESCE(un.note, 0)) AS note_moyenne,
    COUNT(un.id) AS nombre_notes,
    
    -- DÃ©tail des critÃ¨res de notation
...
FROM parking p
-- Jointure rÃ©servations (via chaÃ®ne complÃ¨te)
...
SELECT 
    ...
    -- Nouveaux utilisateurs (ceux qui font leur premiÃ¨re rÃ©servation)
    COUNT(DISTINCT CASE 
